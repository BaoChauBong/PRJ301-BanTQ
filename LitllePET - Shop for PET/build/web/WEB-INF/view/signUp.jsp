...
<html>
    <head>
        <title>LittlePET - Sign up</title>
        <c:import url="component/head.jspf"/>
    </head>

    <body class="sign-in-basic">
        <div class="page-header align-items-start min-vh-100" style="background-image: url('https://media.vov.vn/uploaded/ubmlf0ys1pg/2019_09_16/tn_1_gllg.jpg');" loading="lazy">
                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Welcome to LittlePET</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <c:choose>
