                            ...
                            <div class="row">
                                ...
                                <form action="product" method="POST" class="d-flex justify-content-end mt-2">
                                    <div style="width: 240px;" class="input-group input-group-dynamic mb-4">
                                        ...
                                        <input type="text" name="searchName" value="${requestScope.searchName}" class="form-control" id="basic-url" aria-describedby="basic-addon3" onfocus="focused(this)" onfocusout="defocused(this)">
                                    </div>
                                </form>     
                            </div>
                        </div>
                                            ...
                                            <div id="${requestScope.productID == item.getProductID() ? 'addedProduct': null}" class="card mx-2" data-animation="true" style="max-width: 300px;">
                                                ...
                                                <form action="cart" method="POST" class="mx-4">
                                                    ...
                                                    <div class="card-footer d-flex align-items-center px-0">
                                                        <p class="font-weight-normal my-auto">${item.getFormatedPrice()} VND</p>
