...
<!--                <a href="index.jsp">
                ...
                <!-- img based logo -->
                <a href="${pageContext.request.contextPath}/"><img src="${url}/images/favicon.png" alt="logo img" width="100%"></a> 
              </div>
              <!-- / logo  -->
              <!-- Shipping service -->
              <div class="aa-shipping-box">
                  <a class="aa-shipping-boxsmall">
                      ...
                      <div class="">Khu vực TP Hà Nội</div>
                      </span>
                  ...
                  <a class="aa-shipping-boxsmall">
                      ...
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Hỗ trợ: 033.4950.656</div>
