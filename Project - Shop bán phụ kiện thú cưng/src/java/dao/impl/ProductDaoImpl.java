...
public class ProductDaoImpl extends connectDB implements ProductDao {
    ...
    public void insert(Product product) {
        String sql = "INSERT INTO product(catalog_id, name, price, status, description, "
                + "content, discount, image_link, created) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void edit(Product product) {
        String sql = "UPDATE product SET name = ?, catalog_id = ?, price = ?, status = ?, description = ?, content = ?,"
                + " discount = ?, image_link = ?, created = ? WHERE id = ?";
        Connection con = connectDB.getConnect();
