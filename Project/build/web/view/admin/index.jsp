        ...
        <div class="card mt-3">
            <div class="card-content">
                <div class="row row-group m-0">
                    ...
                    <div class="col-12 col-lg-6 col-xl-3 border-light">
                        <div class="card-body">
                            <h5 class="text-white mb-0">1.200.000 <span class="float-right">VNĐ</span></h5>
                            <div class="progress my-3" style="height:3px;">
                                <div class="progress-bar" style="width:55%"></div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center">
                            <tbody>
                                <tr>
                                    <td><i class="fa fa-circle text-white mr-2"></i>Phụ kiện</td>
                                    <td>580.000 VNĐ</td>
                                    <td>+55%</td>
                                </tr>
                                <tr>
                                    <td><i class="fa fa-circle text-light-1 mr-2"></i>Thực phẩm</td>
                                    <td>1.110.000 VNĐ</td>
                                    <td>+25%</td>
                                </tr>
                                <tr>
                                    <td><i class="fa fa-circle text-light-2 mr-2"></i>Nâng cao sức khỏe</td>
                                    <td>2.155.000 VNĐ</td>
                                    <td>+15%</td>
                                </tr>
                                <tr>
                                    <td><i class="fa fa-circle text-light-3 mr-2"></i>Thú nuôi khác</td>
                                    <td>310.000 VNĐ</td>
                                    <td>+5%</td>
                                </tr>
                            </tbody>
