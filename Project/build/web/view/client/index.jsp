                        ...
                        <div class="col-md-5 no-padding">                
                            <div class="aa-promo-left">
                                <div class="aa-promo-banner">                    
                                    <img src="${url}/images/section1_tc.jpg" alt="quần áo">                    
                                    <div class="aa-prom-content">
                                        <span>Giảm giá 35%</span>
                                        <h4 style ="text-align: center; color: black">Quần áo chó mèo ngộ nghĩnh</h4>                      
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 no-padding">
                            <div class="aa-promo-right">
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/section2_tc.jpg" alt="chuông">                      
                                        <div class="aa-prom-content">
                                            <span>Sản Phẩm độc quyền</span>
                                            <h4 style ="text-align: center; color: black">Pate Whiskas</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        ...
                                        <div class="aa-prom-content">
                                            ...
                                            <h4 style ="text-align: center; color: black">Thuốc bôi diệt ve</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        ...
                                        <div class="aa-prom-content">
                                            ...
                                            <h4 style ="text-align: center; color: black">Hạt mix Beneful</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        ...
                                        <div class="aa-prom-content">
                                            <span>Sản phẩm độc quyền</span>
                                            <h4 style ="text-align: center; color: black">Hạt mix cho Mèo Me-o Thái Lan</h4>                        
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                <li class="active"><a href="#cho" data-toggle="tab">Shop for DOG</a></li>
                                <li><a href="#meo" data-toggle="tab">Shop for CAT</a></li>
                                <li><a href="#box" data-toggle="tab">Pet BOX </a></li>
                                <li><a href="#khac" data-toggle="tab">Thú nuôi khác</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                                <!-- Start DOG product category -->
                                <div class="tab-pane fade in active" id="cho">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${product_cho}" var="product" end="7">
                                            <li>
                                                <figure>
                                ...
                                <!-- / DOG product category -->
                                
                                <!-- start CAT product category -->
                                <div class="tab-pane fade" id="meo">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${product_meo}" var="product" end="7">
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}">
                                                        <img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="polo shirt img">
                                ...
                                <!-- start BOX product category -->
                                <div class="tab-pane fade" id="box">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${product_box}" var="product" end="7">
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}">
                                                        <img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="polo shirt img">
            ...
            <div class="col-md-12">        
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="${url}/images/banner_tc.jpg" alt="banner trang chủ" width="200%" height="200%"></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ul class="aa-product-catg aa-popular-slider">
                                    ...
                                    <c:forEach items="${product_banchay}" var="product">
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}">
                                                    <img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="polo shirt img"></a>
                                                <a class="aa-add-card-btn"href="${pageContext.request.contextPath}/view/client/add-cart?product-id=${product.id}"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ hàng</a>
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}">${product.name }</a></h4>
                                                        <c:choose>
                    ...
                    <ul class="aa-testimonial-slider">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                ...
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                <p> Về chất lượng của sản phẩm thì khỏi phải bàn, luôn chất lượng và phù hợp với giá tiền. Tôi sẽ mua hàng ở đây thường xuyên<p>
                                <div class="aa-testimonial-info">
                                    <p>Mỹ Tân</p>
                                    <span>Diễn Viên</span>
                                </div>
