                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="aa-footer-widget">
                                    <a href="${pageContext.request.contextPath}/">
                                        <img src="${url}/images/favicon.png" alt="logo img" width="50%">
                                    </a> 
                                    <ul class="aa-footer-nav">

                                        <li><p style="color:#888; text-align: justify; width: 95%">
                                                Là nơi đồng hành cùng bạn và thú cưng của bạn trên mỏi nẻo đường.</p></li>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="aa-footer-widget">
                                    <div class="aa-footer-widget">
                                        <h3>LIÊN HỆ</h3>
                                        <address>
                                            <p>Số 60 - Phố Cầu Cốc - Phường Tây Mỗ - Quận Nam Từ Liêm - Hà Nội</p>
                                            <p><span class="fa fa-phone"></span>033.4950.656</p>
                                            <p><span class="fa fa-envelope"></span>littlepet@gmail.com</p>
                                        </address>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="aa-footer-bottom-area">
                        <p>Copyright 2021 &copy BaoChauBong</p>
